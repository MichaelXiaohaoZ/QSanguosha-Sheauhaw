...
config = {
	...
	convert_pairs = {
		...
		"xiaoqiao->miansha_xiaoqiao",
		"xiahouyuan->miansha_xiahouyuan",
		"huangzhong->miansha_huangzhong",
		"weiyan->miansha_weiyan",
		"caoren->miansha_caoren|neo_caoren|bgm_caoren",
		"zhangjiao->miansha_zhangjiao",
		"xuhuang->nos_xuhuang",
		"pangtong->bgm_pangtong",
		"zhangfei->bgm_zhangfei|neo_zhangfei",
		"lvmeng->bgm_lvmeng",
		"liubei->bgm_liubei|miansha_liubei",
		"daqiao->bgm_daqiao",
		"ganning->bgm_ganning",
		"xiahoudun->bgm_xiahoudun|miansha_xiahoudun|neo_xiahoudun",
		"guanyu->nossp_guanyu",
		"machao->jsp_machao",
		"zhaoyun->jsp_zhaoyun|neo_zhaoyun",
		"xiahoushi->sp_xiahoushi",
		"pangde->nos_pangde",
		"zhoucang->nos_zhoucang",
		"caozhen->nos_caozhen",
		"zhuhuan->nos_zhuhuan",
		"chenqun->nos_chenqun",
		"caorui->nos_caorui",
		"caoxiu->nos_caoxiu",
		"quancong->nosquancong",
		"zhuzhi->nos_zhuzhi",
		"liuchen->nos_liuchen",
		"wangyi->miansha_wangyi",
		...
		"maliang->nos_maliang",
		"liuxie->diy_liuxie",
		"gongsunzan->diy_gongsunzan|neo_gongsunzan",
		"luxun->heg_luxun",
		"sunce->heg_sunce|wis_sunce",
		"dongzhuo->heg_dongzhuo",
		"dengai->heg_dengai",
		"jiangwei->heg_jiangwei|wis_jiangwei",
		"caohong->heg_caohong",
		"xusheng->heg_xusheng",
		"yuji->heg_yuji",
		"fuwan->as_fuwan",
		"fuhuanghou->as_fuhuanghou",
		"lingju->as_lingju",
		"lidian->miansha_lidian",
		"zhangchunhua->miansha_zhangchunhua",
		"shencaocao->nosms_shencaocao",
