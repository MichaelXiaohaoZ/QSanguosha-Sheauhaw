    ...
    : TriggerSkill("game_rule")
{
    ...
    events << GameStart << TurnStart
        ...
        << PreCardUsed << CardUsed << TargetConfirmed << CardFinished << CardEffected
        << HpChanged
...
bool GameRule::trigger(TriggerEvent triggerEvent, Room *room, ServerPlayer *player, QVariant &data) const
{
    ...
    case SlashHit: {
        ...
        effect.to->setMark("SlashIsIntensify", (effect.drank + effect.intensify));
