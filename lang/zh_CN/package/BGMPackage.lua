...
return {
	...
	["shyhchour"] = "誓仇",
	[":shyhchour"] = "主公技。限定技。准备阶段开始时，你可以选择一名其他蜀势力角色并交给其两张牌。每当你受到伤害时，你将此伤害转移给该角色，此伤害结算后该角色摸X张牌，直到其第一次进入濒死状态时。（X为伤害点数）",
	["@shyhchour-give"] = "你可以发动“誓仇”",
	["~shyhchour"] = "选择两张牌→选择一名其他蜀势力角色→点击确定",
	["$ShyhchourAnimate"] = "image=image/animate/shyhchour.png",
	["#ShyhchourProtect"] = "%from 的“%arg”被触发，将伤害转移给 %to ",
