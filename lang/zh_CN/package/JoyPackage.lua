...
出牌时机：出牌阶段。\
使用目标：你。\
作用效果：将【洪水】放置于你的判定区里，回合判定阶段进行判定：若判定结果为 A或K，从当前角色的牌随机取出和场上存活人数相等的数量置于桌前，从下家开始，每人选一张收为手牌，将【洪水】置入弃牌堆。若判定结果不为A或K，将【洪水】移到当前角色下家的判定区里",
...
出牌时机：出牌阶段。\
使用目标：你。\
作用效果：将【泥石流】放置于你的判定区里，回合判定阶段进行判定：若判定结果属于黑色A,K,4,7，从当前角色开始，每名角色依次按顺序弃置武器、防具、+1马、-1马，无装备者受到1点无属性伤害，当总共被弃置的装备达到4件或你上家结算完成时，【泥石流】停止结算并置入弃牌堆。若判定牌不属于黑色A,K,4,7，将【泥石流】移动到下家的判定区里",
...
-- equips
	...
	["monkey"] = "猴子",
	[":monkey"] = "装备牌·坐骑\n\
技能：你至其他角色的距离-1；当场上有其他角色使用【桃】时，你可以弃置【猴子】，阻止【桃】的结算并将其收为手牌。",
	["grab_peach"] = "偷桃",

	["gale_shell"] = "狂风甲",
	[":gale_shell"] = "装备牌·防具\n\
技能：<b>锁定技</b>，每次受到火焰伤害时，该伤害+1；你可以将狂风甲装备和你距离为1以内的一名角色的装备区内",
	["#GaleShellDamage"] = "%from 装备【狂风甲】的效果被触发，由 %arg 点火焰伤害增加到 %arg2 点火焰伤害",

	["yx_sword"] = "杨修剑",
	[":yx_sword"] = "装备牌·武器\n\
技能：3<br/>武器特效：当你的【杀】造成伤害时，可以指定攻击范围内的一名其他角色为伤害来源，杨修剑归该角色所有",
